...
if ( ! class_exists( 'Webbox_Playlist_Slider_Widget' ) ) {

	/**
	 * Class Webbox_Playlist_Slider_Widget.
	 */
	class Webbox_Playlist_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			$this->widget_name        = esc_html__( 'Playlist Slider', 'webbox' );
			$this->widget_description = esc_html__( 'Display playlist slider on your site.', 'webbox' );
			$this->widget_id          = apply_filters( 'webbox_playlist_slider_widget_ID', 'webbox_widget_playlist_slider' );
			$this->widget_cssclass    = apply_filters( 'webbox_playlist_slider_widget_cssclass', 'widget-playlist-slider' );
			$this->utility            = webbox_utility()->utility;
			$this->settings = array(
				'title' => array(
					'type'  => 'text',
					'value' => esc_html__( 'Playlist Slider', 'webbox' ),
				...
				'posts_per_page' => array(
					...
					'max_value' => 50,
					'min_value' => 0,
					'label'     => esc_html__( 'Posts count ( Set 0 to show all. )', 'webbox' ),
				),
				'width' => array(
					'type'  => 'text',
					'value' => '100%',
					'label' => esc_html__( 'Slider width ( px, %, rem )', 'webbox' ),
				),
				'height' => array(
					'type' => 'text',
					'value' => '500',
					'label' => esc_html__( 'Slider height ( px, rem )', 'webbox' ),
				),
				'thumbnail_controls' => array(
					...
					'value'   => true,
					'options' => array(
						false => esc_html__( 'Hide', 'webbox' ),
						true  => esc_html__( 'Buttons', 'webbox' ),
					),
					'label'       => esc_html__( 'Select Thumbnail Controls', 'webbox' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'webbox' ),
				),
				'slider_controls' => array(
					...
					'label'       => esc_html__( 'Select Slider Controls', 'webbox' ),
					'placeholder' => esc_html__( 'Select Thumbnail Controls', 'webbox' ),
				),
				'title_length' => array(
					'type'       => 'stepper',
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Title words length ( Set 0 to hide title. )', 'webbox' ),
				),
				'thumb_title_length' => array(
					...
					'min_value'  => '0',
					'step_value' => '1',
					'label'      => esc_html__( 'Thumbnail title words length ( Set 0 to hide title. )', 'webbox' ),
				),
				'mate_data' => array(
					'type'  => 'checkbox',
					'value' => array(
					...
					'options' => array(
						'date'     => esc_html__( 'Date', 'webbox' ),
						'author'   => esc_html__( 'Author', 'webbox' ),
						'comments' => esc_html__( 'Comment count', 'webbox' ),
						'category' => esc_html__( 'Category', 'webbox' ),
						'post_tag' => esc_html__( 'Tag', 'webbox' ),
					),
					'label' => esc_html__( 'Display post meta data', 'webbox' ),
				),
				'thumb_mate_data' => array(
					...
					'label' => esc_html__( 'Display thumbnail post meta data', 'webbox' ),
				),
			);
			...
			$this->layout_settings = apply_filters( 'webbox_playlist_slider_size', array(
		...
		public function widget( $args, $instance ) {
			...
			if ( $this->posts ) {
				$slider_settings = array(
					...
					'buttons'            => apply_filters( 'webbox_playlist_buttons', false ),
...
add_action( 'widgets_init', 'webbox_register_playlist_slider_widget' );
/**
 * Register playlist-slider widget.
 */
function webbox_register_playlist_slider_widget() {
	register_widget( 'Webbox_Playlist_Slider_Widget' );
}
