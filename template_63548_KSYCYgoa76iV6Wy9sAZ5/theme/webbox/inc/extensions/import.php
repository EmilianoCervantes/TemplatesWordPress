...
add_filter( 'cherry_data_import_home_regex_replace', 'webbox_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'webbox_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'webbox_remap_timetable' );
 ...
 * @return array
 */
function webbox_remap_shortcodes( $regex ) {
 ...
 */
function webbox_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function webbox_remap_menus( $posts ) {
