...
if ( ! class_exists( 'Webbox_Widget_Area' ) ) {

	/**
	 * Class Webbox_Widget_Area.
	 */
	class Webbox_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'webbox_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'webbox_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'webbox_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function webbox_widget_area() {
		return Webbox_Widget_Area::get_instance();
	}
