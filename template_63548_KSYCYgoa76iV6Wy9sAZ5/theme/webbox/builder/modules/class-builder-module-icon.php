 ...
 */
class Webbox_Builder_Module_Icon extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Icon', 'webbox' );
		$this->icon = 'f1d8';
	...
	public function get_fields() {
		...
		$fields = array(
			'font_icon' => array(
				'label'               => esc_html__( 'Icon', 'webbox' ),
				'type'                => 'text',
				'option_category'     => 'basic_option',
				'class'               => array( 'tm-pb-font-icon' ),
				'renderer'            => 'tm_pb_get_font_icon_list',
				'renderer_with_field' => true,
				'description'         => esc_html__( 'Choose an icon to display.', 'webbox' ),
			),
			'icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'webbox' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for your icon.', 'webbox' ),
			),
			'use_circle' => array(
				'label'           => esc_html__( 'Circle Icon', 'webbox' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'off' => esc_html__( 'No', 'webbox' ),
					'on'  => esc_html__( 'Yes', 'webbox' ),
				),
				'affects'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set above should display within a circle.', 'webbox' ),
			),
			'circle_color' => array(
				'label'       => esc_html__( 'Circle Color', 'webbox' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle.', 'webbox' ),
			),
			'use_circle_border' => array(
				'label'           => esc_html__( 'Show Circle Border', 'webbox' ),
				'type'            => 'yes_no_button',
				...
				'description'     => esc_html__( 'Here you can choose whether if the icon circle border should display.', 'webbox' ),
			),
			'circle_border_color' => array(
				'label'       => esc_html__( 'Circle Border Color', 'webbox' ),
				'type'        => 'color-alpha',
				'description' => esc_html__( 'Here you can define a custom color for the icon circle border.', 'webbox' ),
			),
			'animation' => array(
				'label'           => esc_html__( 'Icon Animation', 'webbox' ),
				'type'            => 'select',
				'option_category' => 'configuration',
				'options'         => array(
					'top'    => esc_html__( 'Top To Bottom', 'webbox' ),
					'left'   => esc_html__( 'Left To Right', 'webbox' ),
					'right'  => esc_html__( 'Right To Left', 'webbox' ),
					'bottom' => esc_html__( 'Bottom To Top', 'webbox' ),
					'off'    => esc_html__( 'No Animation', 'webbox' ),
				),
				'description'     => esc_html__( 'This controls the direction of the lazy-loading animation.', 'webbox' ),
			),
			'icon_orientation' => array(
				'label'           => esc_html__( 'Icon Orientation', 'webbox' ),
				'type'            => 'select',
				'option_category' => 'layout',
				'options'         => array(
				...
				'description'     => esc_html__( 'This will control how your icon is aligned.', 'webbox' ),
			),
			'use_icon_font_size' => array(
				'label'           => esc_html__( 'Use Icon Font Size', 'webbox' ),
				'type'            => 'yes_no_button',
			...
			'icon_font_size' => array(
				'label'           => esc_html__( 'Icon Font Size', 'webbox' ),
				'type'            => 'range',
				'option_category' => 'font_option',
				'tab_slug'        => 'advanced',
				'default'         => '50px',
			...
			'circle_size' => array(
				'label'           => esc_html__( 'Circle Size', 'webbox' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '100',
				...
				'description'     => esc_html__( 'Here you can define a custom diameter for the icon circle.', 'webbox' ),
				'mobile_options'  => true,
				'depends_default' => true,
			),
			'circle_border_width' => array(
				'label'           => esc_html__( 'Circle Border Width', 'webbox' ),
				'type'            => 'range',
				'option_category' => 'layout',
				'tab_slug'        => 'advanced',
				'default'         => '2',
				...
				'description'     => esc_html__( 'Here you can define a custom width for the icon circle border.', 'webbox' ),
				'depends_default' => true,
			),
			...
			'disabled_on' => array(
				'label'           => esc_html__( 'Disable on', 'webbox' ),
				'type'            => 'multiple_checkboxes',
				'options'         => tm_pb_media_breakpoints(),
				'additional_att'  => 'disable_on',
				'option_category' => 'configuration',
				'description'     => esc_html__( 'This will disable the module on selected devices', 'webbox' ),
			),
			'admin_label' => array(
				'label'       => esc_html__( 'Admin Label', 'webbox' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the module in the builder for easy identification.', 'webbox' ),
			),
			'module_id' => array(
				'label'           => esc_html__( 'CSS ID', 'webbox' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
			...
			'module_class' => array(
				'label'           => esc_html__( 'CSS Class', 'webbox' ),
				'type'            => 'text',
				'option_category' => 'configuration',
				'tab_slug'        => 'custom_css',
				'option_class'    => 'tm_pb_custom_css_regular',
...
new Webbox_Builder_Module_Icon;
