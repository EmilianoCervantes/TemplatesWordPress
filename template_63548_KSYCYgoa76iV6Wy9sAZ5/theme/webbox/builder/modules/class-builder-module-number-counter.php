<?php
/**
 * Class Webbox_Builder_Module_Number_Counter.
 */
class Webbox_Builder_Module_Number_Counter extends Tm_Builder_Module {

	public $function_name;

	public function init() {
		$this->name = esc_html__( 'Number Counter', 'webbox' );
		...
		$this->custom_css_options = array(
			'percent' => array(
				'label'    => esc_html__( 'Percent', 'webbox' ),
				'selector' => '.percent',
			),
			'number_counter_title' => array(
				'label'    => esc_html__( 'Number Counter Title', 'webbox' ),
				'selector' => 'h3',
			),
		);
		...
		$this->advanced_options = array(
			'fonts' => array(
				...
				'number'   => array(
					'label'    => esc_html__( 'Number', 'webbox' ),
					'css'      => array(
	...
	public function get_fields() {
		$fields = array(
			'title' => array(
				...
				'description'     => esc_html__( 'Input a title for the counter.', 'webbox' ),
			),
			'number' => array(
				'label'           => esc_html__( 'Number', 'webbox' ),
				'type'            => 'text',
				'option_category' => 'basic_option',
				'description'     => esc_html__( "Define a number for the counter. (Don't include the percentage sign, use the option below.)", 'webbox' ),
			),
			'percent_sign' => array(
				'label'           => esc_html__( 'Percent Sign', 'webbox' ),
				'type'            => 'yes_no_button',
				'option_category' => 'configuration',
				'options'         => array(
					'on'  => esc_html__( 'On', 'webbox' ),
					'off' => esc_html__( 'Off', 'webbox' ),
				),
				'description'     => esc_html__( 'Here you can choose whether the percent sign should be added after the number set above.', 'webbox' ),
			),
			'counter_color' => array(
				'label'       => esc_html__( 'Counter Text Color', 'webbox' ),
				'type'        => 'color',
				'description' => esc_html__( 'This will change the fill color for the bar.', 'webbox' ),
			),
			'use_icon' => array(
				'label'           => esc_html__( 'Use Icon', 'webbox' ),
				'type'            => 'yes_no_button',
				'option_category' => 'basic_option',
				'options'         => array(
				...
				'description'     => esc_html__( 'Here you can choose whether icon set below should be used.', 'webbox' ),
			),
			'font_icon' => array(
...
new Webbox_Builder_Module_Number_Counter;
