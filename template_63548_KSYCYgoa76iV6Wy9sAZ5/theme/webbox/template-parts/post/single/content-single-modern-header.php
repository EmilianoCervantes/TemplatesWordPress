...
<div class="single-modern-header <?php echo $invert_class = has_post_thumbnail() ? 'invert' : ''; ?>">
	...
	<?php $utility = webbox_utility()->utility; ?>

	<div class="post-thumbnail">
		<?php $utility->media->get_image( array(
			'size'        => 'webbox-thumb-xl',
			'mobile_size' => 'webbox-thumb-xl',
	...
	<div class="container">
		...
		<header class="entry-header">
			...
			<?php $author_visible = webbox_is_meta_visible( 'single_post_author', 'single' );
		...
		<?php if ( 'post' === get_post_type() ) : ?>
			...
			<div class="entry-meta">
				...
				<?php $date_visible = webbox_is_meta_visible( 'single_post_publish_date', 'single' );
				...
				<?php $comment_visible = webbox_is_meta_visible( 'single_post_comments', 'single' );
				...
				<?php $cats_visible = webbox_is_meta_visible( 'single_post_categories', 'single' );
				...
				<?php $tags_visible = webbox_is_meta_visible( 'single_post_tags', 'single' );
		...
		<footer class="entry-footer">
			<?php webbox_share_buttons( 'single' ); ?>
		</footer><!-- .entry-footer -->
